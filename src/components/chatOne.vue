<template>
    <div class="page" ref="pages" >
        <div  ref="talking" @click="cancel"  class="wrap" >
            <div    class="talk-detail" >
                <div>
                    <div style="margin-left: 10px;margin-right: 10px;padding-left:5px;margin-bottom:15px;background: gainsboro">
                        <span style="font-size:12px;color: grey ">
                            将向李康飞，兰凯，李云飞，罗佳廷，赵于博，王长龙，贾亮，冯爽，梁志杰，蔡睿，小胖，波波，刘佳明等12位患者发消息
                        </span>
                    </div>
                        ...
                        <div class="floatLeft">
                            <div class="comment">
                                <div style="float: right;width: 100%">
                                    <p class="mf" >我向你发送了一篇文章 <span style="color: blue">
                    {{item}}
                  </span>快来看吧! </p>
                                </div>
